  ...
  return (
    <div className="site-shell">
      <header className={`site-header ${isScrolled ? 'site-header--scrolled' : ''}`}>
        <a className="brand" href="#home" onClick={closeMenu} aria-label="BTS Farmhouse home">
          <span className="brand-mark"><Leaf size={14} strokeWidth={1.8} /></span>
          <span>BTS <em>Farmhouse</em></span>
        </a>
      ...
      <main>
        ...
        <section className="intro section-pad" id="about">
          <div className="intro-inner page-width">
            <div className="intro-visual">
              <div className="intro-label eyebrow"><span /> Welcome to BTS Farmhouse</div>
            ...
            <div className="intro-copy">
              ...
              <p>BTS Farmhouse is a peaceful private getaway made for the moments that matter. Come together, breathe a little deeper, and enjoy the simple luxury of time well spent.</p>
        ...
        <section className="highlights section-pad" id="amenities">
          <div className="page-width">
            <div className="section-heading">
              <div className="eyebrow"><span /> The BTS feeling</div>
        ...
        <section className="marquee-section section-pad" id="gallery">
          <div className="marquee-intro page-width">
            <div className="eyebrow"><span /> A glimpse of BTS</div>
      ...
      <footer className="footer">
        <div className="page-width footer-grid">
          ...
          <div className="footer-contact">
            ...
            <a href="mailto:hello@btsfarmhouse.com"><MessageCircle size={15} /> hello@btsfarmhouse.com</a>
          </div>
        </div>
        <div className="footer-bottom page-width">
          <span>© 2026 BTS Farmhouse. All rights reserved.</span>
